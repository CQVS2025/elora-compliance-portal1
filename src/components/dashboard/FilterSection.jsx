        ...
        <div className="flex flex-wrap items-center gap-4">
          {lockCustomerFilter && displayName ? (
            ...
            <div className="w-[180px] shrink-0">
              ...
              >
                <SelectTrigger className="h-10 w-full min-w-0 rounded-lg">
          ...
          {onResetDateRange && (
            <Button
              ...
              variant="outline"
              size="sm"
              className="h-10 shrink-0 rounded-lg text-muted-foreground hover:text-foreground"
          ...
          <AnimatePresence mode="wait">
            {showSyncingPill ? (
              <motion.div
                ...
                className="relative flex items-center gap-2.5 rounded-lg border border-amber-500/30 bg-amber-500/10 px-4 py-2"
              >
              ...
              <motion.div
                ...
                exit={{ opacity: 0, x: -6 }}
                transition={{ duration: 0.22, ease: [0.25, 0.46, 0.45, 0.94] }}
                className="relative flex items-center gap-2.5 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-4 py-2"
              >
                <span className="relative flex h-2.5 w-2.5">
